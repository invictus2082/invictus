...
#if defined(NDEBUG)
# error "Invictus cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Invictus Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("invictus-scriptch");
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Invictus: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet & regtest uses supermajority)
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Invictus: (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
