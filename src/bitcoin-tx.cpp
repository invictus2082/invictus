...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Invictus Core invictus-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  invictus-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded invictus transaction") + "\n" +
              "  invictus-tx [options] -create [commands]   " + _("Create hex-encoded invictus transaction") + "\n" +
              "\n";
